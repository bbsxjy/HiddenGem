...
try:
    ...
    logger.warning(f" pymongo 未安装，MongoDB功能不可用")
...
try:
    ...
    logger.warning(f" redis 未安装，Redis功能不可用")
    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        if self.mongodb_db is not None:
            try:
                ...
                logger.error(f" MongoDB统计获取失败: {e}")
