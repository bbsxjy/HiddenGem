...
class StockUtils:
    ...
    @staticmethod
    def is_china_index(ticker: str) -> bool:
        """
        判断是否为中国A股指数
        ...
        return (re.match(r'^000\d{3}\.(SH|SZ)$', ticker) is not None or
                re.match(r'^399\d{3}\.SZ$', ticker) is not None)
