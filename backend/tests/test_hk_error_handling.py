...
def main():
    ...
    if passed == total:
        ...
        print("\n 处理流程:")
        print("1⃣ 尝试AKShare获取完整港股数据")
        print("2⃣ 如果部分失败，使用默认信息继续处理")
        print("3⃣ 如果完全失败，尝试Yahoo Finance备用")
        print("4⃣ 最终备用：提供基础信息和建议")
